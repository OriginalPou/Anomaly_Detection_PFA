...
#define AI_NET_OBJ_INSTANCE g_anomaly_detection
 
#undef AI_ANOMALY_DETECTION_MODEL_SIGNATURE
#define AI_ANOMALY_DETECTION_MODEL_SIGNATURE     "fceaa32a8dd6b12c9e3fb95bac52a09a"
...
#define AI_TOOLS_DATE_TIME   "Tue Jun 15 00:10:12 2021"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_ANOMALY_DETECTION_N_BATCHES
#define AI_ANOMALY_DETECTION_N_BATCHES         (1)
...
AI_STATIC ai_array dense_3_nl_output_array;   /* Array #18 */
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 270, 128, 1, 1), AI_STRIDE_INIT(4, 4, 1080, 138240, 138240),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 270, 1, 1), AI_STRIDE_INIT(4, 4, 4, 1080, 1080),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 768, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_ANOMALY_DETECTION_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_ANOMALY_DETECTION_OUT_NUM, &dense_4_output),
  &dense_layer, 0, NULL)
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_ANOMALY_DETECTION_MODEL_NAME,
